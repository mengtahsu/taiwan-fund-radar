...
assert(fundBoxSource.includes('const VERSION = "1.1"'), "fund box algorithm should declare a version");
...
assert(fundBoxSource.includes('label: "續抱，不停利"'), "healthy or rising funds should not trigger profit-taking");
assert(fundBoxSource.includes('label: "停損訊號"'), "three-day confirmed breakdowns should clearly show a stop-loss signal");
